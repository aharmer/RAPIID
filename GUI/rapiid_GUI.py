...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5.addWidget(self.camera_1_exposure_label)
        self.spinBox_camera_1_exposure = QtWidgets.QSpinBox(self.horizontalWidget)
        self.spinBox_camera_1_exposure.setButtonSymbols(QtWidgets.QAbstractSpinBox.UpDownArrows)
        ...
        self.verticalLayout_5.addWidget(self.spinBox_camera_1_exposure)
        ...
        self.verticalLayout_8.addWidget(self.camera_1_gain_label)
        ...
        self.verticalLayout_8.addWidget(self.doubleSpinBox_camera_1_gain)
        ...
        self.verticalLayout_9.addWidget(self.camera_1_gamma_label)
        ...
        self.verticalLayout_9.addWidget(self.doubleSpinBox_camera_1_gamma)
...
"}")
        ...
        self.spinBox_7 = QtWidgets.QSpinBox(self.horizontalWidget)
        self.spinBox_7.setKeyboardTracking(False)
        self.spinBox_7.setMinimum(1000)
        self.spinBox_7.setMaximum(1000000)
        self.spinBox_7.setSingleStep(10000)
        self.spinBox_7.setProperty("value", 90000)
        ...
        self.doubleSpinBox_8 = QtWidgets.QDoubleSpinBox(self.horizontalWidget)
        self.doubleSpinBox_8.setKeyboardTracking(False)
        self.doubleSpinBox_8.setMaximum(25.0)
        self.doubleSpinBox_8.setProperty("value", 1.83)
        self.doubleSpinBox_8.setObjectName("doubleSpinBox_8")
        self.verticalLayout_14.addWidget(self.doubleSpinBox_8)
        ...
        self.doubleSpinBox_9 = QtWidgets.QDoubleSpinBox(self.horizontalWidget)
        self.doubleSpinBox_9.setKeyboardTracking(False)
        self.doubleSpinBox_9.setMinimum(0.1)
        self.doubleSpinBox_9.setMaximum(4.0)
        ...
        self.verticalLayout_15.addWidget(self.doubleSpinBox_9)
        ...
        self.label_4.setMinimumSize(QtCore.QSize(540, 405))
        self.label_4.setMaximumSize(QtCore.QSize(540, 405))
...
"}")
        ...
        self.camera_3.setMaximumSize(QtCore.QSize(540, 405))
...
"}")
        ...
        self.spinBox_10.setMinimum(1000)
        self.spinBox_10.setMaximum(1000000)
        self.spinBox_10.setSingleStep(10000)
        self.spinBox_10.setProperty("value", 90000)
        ...
        self.doubleSpinBox_11.setKeyboardTracking(False)
        self.doubleSpinBox_11.setMaximum(25.0)
        self.doubleSpinBox_11.setProperty("value", 1.83)
        ...
        self.doubleSpinBox_12.setKeyboardTracking(False)
        self.doubleSpinBox_12.setMinimum(0.1)
        self.doubleSpinBox_12.setMaximum(4.0)
        self.doubleSpinBox_12.setSingleStep(0.1)
        self.doubleSpinBox_12.setProperty("value", 0.8)
        ...
        self.label_8.setMinimumSize(QtCore.QSize(540, 405))
...
"}")
        ...
        self.spinBox_16.setKeyboardTracking(False)
        self.spinBox_16.setMinimum(1000)
        self.spinBox_16.setMaximum(1000000)
        self.spinBox_16.setSingleStep(10000)
        self.spinBox_16.setProperty("value", 90000)
        ...
        self.doubleSpinBox_17.setKeyboardTracking(False)
        self.doubleSpinBox_17.setMaximum(25.0)
        self.doubleSpinBox_17.setProperty("value", 1.83)
        ...
        self.doubleSpinBox_18.setKeyboardTracking(False)
        self.doubleSpinBox_18.setMinimum(0.1)
        self.doubleSpinBox_18.setMaximum(4.0)
        self.doubleSpinBox_18.setSingleStep(0.1)
        self.doubleSpinBox_18.setProperty("value", 0.8)
        ...
        self.label_10.setMinimumSize(QtCore.QSize(540, 405))
        self.label_10.setMaximumSize(QtCore.QSize(540, 405))
...
"}")
        ...
        self.spinBox_19.setKeyboardTracking(False)
        self.spinBox_19.setMinimum(1000)
        self.spinBox_19.setMaximum(1000000)
        self.spinBox_19.setSingleStep(10000)
        self.spinBox_19.setProperty("value", 90000)
        ...
        self.doubleSpinBox_20.setKeyboardTracking(False)
        self.doubleSpinBox_20.setMaximum(25.0)
        self.doubleSpinBox_20.setProperty("value", 1.83)
        ...
        self.doubleSpinBox_21.setMinimum(0.1)
        self.doubleSpinBox_21.setMaximum(4.0)
        self.doubleSpinBox_21.setSingleStep(0.1)
        self.doubleSpinBox_21.setProperty("value", 0.8)
        ...
        self.label_12.setMinimumSize(QtCore.QSize(540, 405))
        self.label_12.setMaximumSize(QtCore.QSize(540, 405))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_20.setText(_translate("MainWindow", "Exposure time (us)"))
        self.label_21.setText(_translate("MainWindow", "Gain level (dB)"))
        self.label_22.setText(_translate("MainWindow", "Gamma correction"))
