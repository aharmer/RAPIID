...
class UI(QMainWindow):
    ...
    def writeConfig(self):
        ...
        config = {'general': {'project_name': self.ui.lineEdit_project.text(),
                  ...
                  'camera_settings': {'camera_1': {'exposure_time': self.ui.spinBox_camera_1_exposure.value(),
    ...
    def get_default_values(self):
        ...
        config = {'general': {'project_name': 'untitled_project'},
                       'exif_data': {'camera_1': {'Make': 'FLIR',
                                                  'Model': 'BFS-U3-200S6C-C',
                                                  'SerialNumber': '21447407',
                                                  'Lens': 'MPZ',
                                                  'CameraSerialNumber': '21447407',
